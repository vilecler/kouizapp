...
class FacebookButtonWidget extends StatelessWidget  {
  FacebookButtonWidget({Key? key, required this.text, this.onTap}) : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                color: CustomColors.facebookColor.withOpacity(0.8),
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              const FaIcon(FontAwesomeIcons.facebookF, color: CustomColors.white, size: 17.0,),
              Padding(
