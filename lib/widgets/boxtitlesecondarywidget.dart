...
class BoxTitleSecondaryWidget extends StatelessWidget {
  const BoxTitleSecondaryWidget({Key? key, required this.title}) : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          title,
                          style: const TextStyle(color: CustomColors.white, fontSize: 23.0, decoration: TextDecoration.none, fontWeight: FontWeight.w800, letterSpacing: 1.0, fontFamily: 'Roboto'),
                        ),
                      ),
